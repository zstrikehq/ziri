...
**API Keys** - Keys that identify users. Format: `sk-zs-{userId}-{hash}`. You can create an API key during user creation or create/rotate keys later from the Keys page.
