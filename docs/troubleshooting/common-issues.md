...
## Master Key Regenerating

**Problem**: Master key changes on every restart.

**Solution**:

Set `ZIRI_MASTER_KEY` environment variable in Docker Compose:

```yaml
environment:
  - ZIRI_MASTER_KEY=your-persistent-key
```
